    ...
    return (
        ...
        >
            ...
            >
                ...
                <PrimaryButton  textWeight={500} textSize={20} style={{ width: "100%", height: 35 }} onPress={onPrimaryPress}>
                    {type1}
                </PrimaryButton>
                ) : (
                ...
                {type2 !== "" && (
                    <PrimaryButton  textWeight={500} textSize={20} style={{ width: "100%", height: 35 }} onPress={onSecondaryPress}>
                        {type2}
                    </PrimaryButton>
                )}
            </View>
