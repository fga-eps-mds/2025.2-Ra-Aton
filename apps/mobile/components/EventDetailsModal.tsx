            ...
            <View style={[styles.modalContent, { backgroundColor: theme.background }]}>
                ...
                <View style={styles.body}>
                    ...
                    <View style={[styles.infoRow, { borderTopColor: theme.gray }]}>
                        ...
                        <View>
                            <Text style={[styles.infoLabel, { color: theme.text }]}>Data</Text>
                    ...
                    <View style={[styles.infoRow, { borderTopColor: theme.gray }]}>
                        ...
                        <View>
                            <Text style={[styles.infoLabel, { color: theme.text }]}>Horário</Text>
                            <Text style={[styles.infoValue, { color: theme.text }]}>
                                {formattedTime}
                            </Text>
                        </View>
                    ...
                    <View style={[styles.infoRow, { borderTopColor: theme.gray }]}>
                        ...
                        <View>
                            <Text style={[styles.infoLabel, { color: theme.text }]}>Local</Text>
                            <Text style={[styles.infoValue, { color: theme.text }]}>
                                {post.event?.location}
                            </Text>
                        </View>
