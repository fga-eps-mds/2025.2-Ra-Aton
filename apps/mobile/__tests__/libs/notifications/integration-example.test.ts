// ARQUIVO: __tests__/libs/notifications/registerNotifications.test.ts
...
// MOCK CRÍTICO PARA EXPO MODULES CORE (CORREÇÃO)
// Impede que as bibliotecas do Expo tentem carregar código nativo
...
function loadModule() {
  // O isolateModules garante que o módulo seja reavaliado (e os requires condicionais executados)
